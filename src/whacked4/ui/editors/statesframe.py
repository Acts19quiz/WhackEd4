...
class StatesFrame(editormixin.EditorMixin, windows.StatesFrameBase):
    ...
    def build(self, patch):
        ...
        self.SpritePreview.set_baseline_factor(0.85)# WhackEd4
        self.SpritePreview.set_scale(2)# WhackEd4
    ...
    def statelist_build(self):
        ...
        if self.StateList.GetColumnCount() == 0:
            ...
            self.StateList.InsertColumn(1, 'Name', width=57)# WhackEd4
            self.StateList.InsertColumn(2, 'Spr', width=39)# WhackEd4
            self.StateList.InsertColumn(3, 'Frm', width=39)# WhackEd4

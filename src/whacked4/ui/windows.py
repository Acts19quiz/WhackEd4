...
STATES_SPRITE = 1761
STATES_FRAME = 1762
STATES_FRAMESPIN = 1763
STATES_LIT = 1764
STATES_NEXT = 1765
STATES_DURATION = 1766
STATES_FAST = 1767
STATES_ACTION = 1768
STATES_LABEL_UNUSED1 = 1769
STATES_UNUSED1 = 1770
STATES_LABEL_UNUSED2 = 1771
STATES_UNUSED2 = 1772
STATES_LABEL_ARG1 = 1773
STATES_ARG1 = 1774
STATES_LABEL_ARG2 = 1775
STATES_ARG2 = 1776
STATES_LABEL_ARG3 = 1777
STATES_ARG3 = 1778
STATES_LABEL_ARG4 = 1779
STATES_ARG4 = 1780
STATES_LABEL_ARG5 = 1781
STATES_ARG5 = 1782
STATES_LABEL_ARG6 = 1783
STATES_ARG6 = 1784
STATES_LABEL_ARG7 = 1785
STATES_ARG7 = 1786
STATES_LABEL_ARG8 = 1787
STATES_ARG8 = 1788
STATES_LABEL_ARG9 = 1789
STATES_ARG9 = 1790
STATES_FILTER = 1791
STATES_FILTERTOOLS = 1792
STATES_FILTERTOOLS_REFRESH = 1793
FRAME_SOUNDS = 1794
SOUNDS_PRIORITY = 1795
SOUNDS_PRIORITYSPIN = 1796
SOUNDS_SINGULAR = 1797
SOUNDS_RESTORE = 1798
SOUNDS_LIST = 1799
FRAME_STRINGS = 1800
STRINGS_LIST = 1801
STRINGS_RESTORE = 1802
FRAME_WEAPONS = 1803
WEAPON_AMMOTYPE = 1804
WEAPON_VAL_AMMO_USE = 1805
WEAPON_VAL_MIN_AMMO = 1806
WEAPON_VAL_DECAL = 1807
WEAPON_STATE_SELECT = 1808
WEAPON_STATENAME_SELECT = 1809
WEAPON_STATESET_SELECT = 1810
WEAPON_STATE_DESELECT = 1811
WEAPON_STATENAME_DESELECT = 1812
WEAPON_STATESET_DESELECT = 1813
WEAPON_STATE_BOB = 1814
WEAPON_STATENAME_BOB = 1815
WEAPON_STATESET_BOB = 1816
WEAPON_STATE_FIRE = 1817
WEAPON_STATENAME_FIRE = 1818
WEAPON_STATESET_FIRE = 1819
WEAPON_STATE_MUZZLE = 1820
WEAPON_STATENAME_MUZZLE = 1821
WEAPON_STATESET_MUZZLE = 1822
WEAPON_RENAME = 1823
WEAPON_RESTORE = 1824
FRAME_AMMO = 1825
AMMO_VAL_MAXIMUM = 1826
AMMO_VAL_PICKUP = 1827
AMMO_RENAME = 1828
AMMO_RESTORE = 1829
AMMO_LIST = 1830
FRAME_CHEATS = 1831
...
class ThingsFrameBase ( wx.MDIChildFrame ):
	...
	def __init__( self, parent ):
		wx.MDIChildFrame.__init__ ( self, parent, id = FRAME_THINGS, title = u"Things", pos = wx.DefaultPosition, size = wx.Size( 980,737 ), style = wx.CAPTION|wx.CLOSE_BOX|wx.MAXIMIZE_BOX|wx.RESIZE_BORDER|wx.SYSTEM_MENU|wx.TAB_TRAVERSAL )

		self.SetSizeHints( wx.Size( 980,737 ), wx.DefaultSize )
		...
		SizerInfight = wx.BoxSizer( wx.HORIZONTAL )

		self.ThingInfightLabel = wx.StaticText( self.PanelInfight, wx.ID_ANY, u"Infighting group", wx.DefaultPosition, wx.Size( 90,-1 ), 0 )
		self.ThingInfightLabel.Wrap( -1 )

		SizerInfight.Add( self.ThingInfightLabel, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 3 )
		...
		SizerInfight.Add( self.ThingInfight, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 3 )


		self.PanelInfight.SetSizer( SizerInfight )
		self.PanelInfight.Layout()
		SizerInfight.Fit( self.PanelInfight )
		...
		SizerProjectile = wx.BoxSizer( wx.HORIZONTAL )

		self.ThingProjectileLabel = wx.StaticText( self.PanelProjectile, wx.ID_ANY, u"Projectile group", wx.DefaultPosition, wx.Size( 90,-1 ), 0 )
		self.ThingProjectileLabel.Wrap( -1 )

		SizerProjectile.Add( self.ThingProjectileLabel, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 3 )
		...
		SizerProjectile.Add( self.ThingProjectile, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 3 )


		self.PanelProjectile.SetSizer( SizerProjectile )
		self.PanelProjectile.Layout()
		SizerProjectile.Fit( self.PanelProjectile )
		SizerProperties.Add( self.PanelProjectile, 0, 0, 0 )

		self.PanelSplash = wx.Panel( self.PanelProperties, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		SizerSplash = wx.BoxSizer( wx.HORIZONTAL )

		self.ThingSplashLabel = wx.StaticText( self.PanelSplash, wx.ID_ANY, u"Splash group", wx.DefaultPosition, wx.Size( 90,-1 ), 0 )
		self.ThingSplashLabel.Wrap( -1 )

		SizerSplash.Add( self.ThingSplashLabel, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 3 )

		self.ThingSplash = wx.TextCtrl( self.PanelSplash, THING_VAL_SPLASH, wx.EmptyString, wx.DefaultPosition, wx.Size( 50,-1 ), 0 )
		self.ThingSplash.SetMaxLength( 6 )
		SizerSplash.Add( self.ThingSplash, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 3 )


		self.PanelSplash.SetSizer( SizerSplash )
		self.PanelSplash.Layout()
		SizerSplash.Fit( self.PanelSplash )
		SizerProperties.Add( self.PanelSplash, 0, 0, 0 )
		...
		self.ThingInfightLabel.Bind( wx.EVT_ERASE_BACKGROUND, self.dummy )
		self.ThingInfight.Bind( wx.EVT_LEFT_UP, self.focus_text )
		self.ThingInfight.Bind( wx.EVT_TEXT, self.set_value )
		self.ThingProjectileLabel.Bind( wx.EVT_ERASE_BACKGROUND, self.dummy )
		self.ThingProjectile.Bind( wx.EVT_LEFT_UP, self.focus_text )
		self.ThingProjectile.Bind( wx.EVT_TEXT, self.set_value )
		self.ThingSplashLabel.Bind( wx.EVT_ERASE_BACKGROUND, self.dummy )
		self.ThingSplash.Bind( wx.EVT_LEFT_UP, self.focus_text )
		self.ThingSplash.Bind( wx.EVT_TEXT, self.set_value )

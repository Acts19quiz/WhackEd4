...
class ThingsFrameBase ( wx.MDIChildFrame ):
	...
	def __init__( self, parent ):
		...
		self.ThingInfight = wx.TextCtrl( self.PanelInfight, THING_VAL_INFIGHT, wx.EmptyString, wx.DefaultPosition, wx.Size( 100,-1 ), 0 )
		self.ThingInfight.SetMaxLength( 6 )
		SizerInfight.Add( self.ThingInfight, 1, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 3 )


		self.PanelInfight.SetSizer( SizerInfight )
		self.PanelInfight.Layout()
		SizerInfight.Fit( self.PanelInfight )
		SizerProperties.Add( self.PanelInfight, 0, wx.EXPAND, 0 )
		...
		self.ThingProjectile = wx.TextCtrl( self.PanelProjectile, THING_VAL_PROJECTILE, wx.EmptyString, wx.DefaultPosition, wx.Size( 100,-1 ), 0 )
		self.ThingProjectile.SetMaxLength( 6 )
		SizerProjectile.Add( self.ThingProjectile, 1, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 3 )


		self.PanelProjectile.SetSizer( SizerProjectile )
		self.PanelProjectile.Layout()
		SizerProjectile.Fit( self.PanelProjectile )
		SizerProperties.Add( self.PanelProjectile, 0, wx.EXPAND, 0 )
		...
		self.ThingSplash = wx.TextCtrl( self.PanelSplash, THING_VAL_SPLASH, wx.EmptyString, wx.DefaultPosition, wx.Size( 100,-1 ), 0 )
		self.ThingSplash.SetMaxLength( 6 )
		SizerSplash.Add( self.ThingSplash, 1, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 3 )


		self.PanelSplash.SetSizer( SizerSplash )
		self.PanelSplash.Layout()
		SizerSplash.Fit( self.PanelSplash )
		SizerProperties.Add( self.PanelSplash, 0, wx.EXPAND, 0 )

...
class AboutDialogBase ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = DIALOG_ABOUT, title = u"About WhackEd4 REDSKULL", pos = wx.DefaultPosition, size = wx.Size( 640,440 ), style = wx.CAPTION|wx.CLOSE_BOX )
